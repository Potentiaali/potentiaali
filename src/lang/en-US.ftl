...
event-notification-body-1-2021 = Kumpulan Potentiaali -event is unfortunately postponed until February of 2022 due to the ongoing covid-19 situation.
event-notification-body-2-2021 = The registration for Kumpulan Potentiaali is currently closed but will be reopened when the new date is specified!
event-notification-body-2-2021-url = Registration for companies
event-notification-body-3-2021 = You can also reach us
