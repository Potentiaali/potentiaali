...
event-notification-title-2021 = Tiedote koskien Kumpulan Potentiaali 2021 -tapahtumaa
event-notification-body-1-2021 = Kumpulan Potentiaali tapahtumaa on lykätty vuoden 2022 Helmikuulle nykyisen covid-19 tilanteen takia.
event-notification-body-2-2021 = Ilmoittautuminen on tällä hetkellä kiinni, mutta se avataan uudelleen kun tapahtuman uusi päivämäärä on selvillä!
event-notification-body-2-2021-url = Ilmoittautumislomake yrityksille
event-notification-body-3-2021 = Olemme lähestyneet jo rekisteröityneitä yrityksiä tapahtuman lykkääntymisestä, mutta jos teillä on vielä kysyttävää saa myös kiinni
