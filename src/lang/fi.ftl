...
main-part-1 = Kumpulan Potentiaali on Helsingin yliopiston
          ...
          kertaa; vuosina 2017, 2018, 2019 ja 2022. Kumpulan Potentiaali on ollut
...
registration-main-part-1 = Kumpulan Potentiaali on Helsingin Yliopiston
            matemaattis-luonnontieteellisen tiedekunnan opiskelijoiden järjestämä
...
registration-main-part-2 = Vuonna 2017 yli 95% kertoi tapahtuman olleen vähintään hinnan väärti.
includes = Sisältö
...
registration-notification-text = Yritysilmoittautuminen Kumpulan Potentiaali 2023 -tapahtumaan on nyt auki!
...
exhibitors = Yritystä
mapPage = Kartta
companies-title-text = Vuoden 2023 Kumpulan Potentiaali -tapahtumaan osallistuvat yritykset
...
go-back = Takaisin
go-to-company-listing = Näytä vuoden 2023 Kumpulan Potentiaaliin osallistuvat yritykset
fullscreen = Koko näytön tila
event-notification-title = Kumpulan Potentiaali 2023 on tulossa.
event-notification-body-1 = Kumpulan potentiaali järjestetään 2022 syksyllä 23.11.2023
event-notification-body-2 = Lisää tietoa tulossa myöhemmin, kannattaa olla valmis!
